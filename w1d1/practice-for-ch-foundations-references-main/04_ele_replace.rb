# Write a method, ele_replace!(array, hash), that accepts an array and a hash as
# args. The method should mutate the given array by replacing elements with
# their corresponding values in the hash. The method should return the given
# array.
#
