...
# replacing the given idx of the str with the char. The method should return the
# str.
# 
...
# The exact object_ids you get back don't matter. You just want the ids to be
